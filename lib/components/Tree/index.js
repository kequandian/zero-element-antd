...
var _formatInit = _interopRequireDefault(require("./formatInit"));
...
var _default = function _default(props) {
  var API = props.API,
      ...
      defaultAelectedKeys = props.defaultAelectedKeys,
      rest = (0, _objectWithoutProperties2["default"])(props, ["API", "searchField", "namespace", "initData", "onChange", "defaultAelectedKeys"]);
  ...
  function handleLoadData(treeNode) {
    ...
    setTreeLoading(true);
    return (0, _request.query)(api).then(function (data) {
      var _find$children;

      var find = (0, _findNode["default"])(id, treeData);
      find.children = find.children || [];

      (_find$children = find.children).push.apply(_find$children, (0, _toConsumableArray2["default"])((0, _checkData["default"])(data)));
  ...
  function handleRemoteSearch(value) {
    ...
    setTreeLoading(true);
    return (0, _request.query)(api, (0, _defineProperty2["default"])({}, searchField, value)).then(function (data) {
      var rst = (0, _checkData["default"])(data);
  ...
  }), treeData && (treeData.length || Object.keys(treeData).length) ? /*#__PURE__*/_react["default"].createElement(_tree["default"], (0, _extends2["default"])({
    showLine: true,
    autoExpandParent: autoExpandParent
  }, treeProps), (0, _read["default"])(treeData)) : /*#__PURE__*/_react["default"].createElement(_empty["default"], null));
};
