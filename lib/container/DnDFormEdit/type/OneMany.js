...
function SRadio(_ref) {
  ...
  return sql.value ? _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement(Title, {
    level: 4
  }, "\u4E00\u5BF9\u591A\u5173\u7CFB: ", _react["default"].createElement(Text, {
    code: true
  }, sql.value)), _react["default"].createElement(_table["default"], {
    dataSource: [],
