...
function Render(props) {
  ...
  var labelClassNames = ['ZEleA-Form-item-label', rules.required && rules.required.value ? 'ant-form-item-required' : '', base.label.value ? 'ZEleA-Form-item-label-colon' : ''];
  ...
  }, base.label.value) : null, _react["default"].createElement("div", {
