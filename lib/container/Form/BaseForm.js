...
function BaseForm(props) {
  ...
  var initData = (0, _react.useRef)(_objectSpread({}, extraData, {
    data: data
  }));
  ...
  var _useFormHandle = (0, _useFormHandle3["default"])(namespace, {
    ...
    onGetOne: handleGetData
      ...
      _useFormHandle2$ = _useFormHandle2[0],
      model = _useFormHandle2$.model,
      formatValueRef = _useFormHandle2$.formatValueRef,
      _useFormHandle2$2 = _useFormHandle2[1],
      onFormatValue = _useFormHandle2$2.onFormatValue,
      onSaveOtherValue = _useFormHandle2$2.onSaveOtherValue,
      onGetFormData = _useFormHandle2$2.onGetFormData,
      bindOnChange = _useFormHandle2$2.bindOnChange,
      onSpyChange = _useFormHandle2$2.onSpyChange;
  ...
  (0, _lifeCycle.useDidMount)(function (_) {
    ...
    if (onSetExtraElement && goBack) {
      onSetExtraElement(_react["default"].createElement(_button["default"], {
        onClick: goBack
      }, "\u8FD4\u56DE"));
    }
  });
  ...
  }, destroy ? null : _react["default"].createElement(_reactFinalForm.Form, {
