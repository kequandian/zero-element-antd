...
function FormItemWrapped(_ref) {
  ...
  return _react["default"].createElement("div", {
    className: "ZEle-Form-item"
  }, label ? _react["default"].createElement("label", {
    className: "ZEle-Form-item-label"
  }, "".concat(label, ":")) : null, _react["default"].createElement(_antd.Tooltip, {
    ...
    n: type,
    className: "ZEle-Form-item-element ".concat(visibleError ? 'ZEle-Form-ruleTips-error' : ''),
    options: options
  }, input, rest))));
}