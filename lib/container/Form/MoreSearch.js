...
export default function BaseSearch(props) {
  ...
  renderFieldsAndButton.splice(collapse, 0, /*#__PURE__*/React.createElement(React.Fragment, null)); // console.log(renderFieldsAndButton,"FIELDANDBUTTON",collapse)
  ...
  return /*#__PURE__*/React.createElement(Spin, {
    ...
    n: layout,
    value: value
  }, layoutConfig), renderFieldsAndButton), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      right: "20px",
      bottom: "5px"
    }
  }, type === "default" ? Footer(validLength) : renderFooter(validLength)))) : null);
}
