...
export default function BaseTable(props) {
  ...
  return /*#__PURE__*/React.createElement(Render, _extends({
    ...
    handle: handle,
    namespace: namespace
  }), canPortal(extraEl, /*#__PURE__*/React.createElement(React.Fragment, null, renderBatchOperation(), /*#__PURE__*/React.createElement(Render, {
    n: 'Row'
  }, actionsItems))), /*#__PURE__*/React.createElement(Table, _extends({
    rowKey: "id",
    size: "middle",
