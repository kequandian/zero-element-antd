...
function formatTableFields() {
  ...
  if (operation.length > 0) {
    operationObj = _objectSpread({
      ...
      title: handle.onFieldsOrder ? function () {
        return /*#__PURE__*/_react["default"].createElement(_ListFieldsEdit["default"], {
          fields: props.fields,
          handle: handle
        });
      } : '操作',
      render: function render(text, record, index) {
        return /*#__PURE__*/_react["default"].createElement(_ListOperation["default"], (0, _extends2["default"])({}, props, {
          text: text,
          record: record,
          index: index,
          operation: operation,
  ...
  return {
    columns: operationObj ? [].concat((0, _toConsumableArray2["default"])(rst), [operationObj]) : (0, _toConsumableArray2["default"])(rst),
    width: width
  };
}
...
function valueTypeRender(type, config, props, handle) {
  ...
  return function (text, record, index) {
    return /*#__PURE__*/_react["default"].createElement(_valueType.Render, (0, _extends2["default"])({
      n: type
    }, config, props, {
      data: {
        text: text,
