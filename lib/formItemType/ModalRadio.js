...
function ModalRadio(props) {
  var name = props.name,
      ...
      rest = (0, _objectWithoutProperties2["default"])(props, ["name", "value", "namespace", "options", "props", "onChange", "handle", "hooks"]);
  ...
  (0, _lifeCycle.useWillUnmount)(function (_) {
    (0, _Model.removeModel)("".concat(namespace, "_").concat(name, "_ModalRadio"));
  });
  ...
  function handleSave() {
    ...
    if (typeof formFieldMap === 'function') {
      formFieldMap(name, selectedData.current).then(function (data) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_button["default"], {
    ...
    namespace: "".concat(namespace, "_").concat(name, "_ModalRadio"),
    options: {
      API: API,
      fields: fields,
      type: 'radio',
