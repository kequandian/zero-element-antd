...
function PCDMultiple(props) {
  ...
  var _useState5 = (0, _react.useState)([]),
      ...
      setProvince = _useState6[1]; // 当前勾选的 省 列表
  ...
  var _useState9 = (0, _react.useState)([]),
      ...
      city = _useState10[0],
      setCity = _useState10[1]; // 当前勾选的 市 列表
  ...
  var _useState13 = (0, _react.useState)([]),
      ...
      setDistrict = _useState14[1]; // 当前勾选的 区 列表
  ...
  function handleAppendToValue(data) {
    if (Array.isArray(value)) {
      onChange((0, _toConsumableArray2["default"])(new Set([].concat((0, _toConsumableArray2["default"])(value), (0, _toConsumableArray2["default"])(data)))));
    } else {
      onChange(data);
    }
  }
