...
function RichText(props) {
  ...
  var braftEditor = (0, _react.useRef)(_braftEditor["default"].createEditorState(value));
  (0, _lifeCycle.useDidMount)(function (_) {
    ...
    braftEditor.current = _braftEditor["default"].createEditorState(braftEditor.current.toHTML());
    setCanDo(true);
  });
  ...
  if (canDo) {
    return /*#__PURE__*/_react["default"].createElement(_braftEditor["default"], (0, _extends2["default"])({
      name: name
    }, rest, p, {
