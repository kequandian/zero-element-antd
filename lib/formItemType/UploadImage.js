...
function UploadImage(props) {
  var value = props.value,
      ...
      rest = (0, _objectWithoutProperties2["default"])(props, ["value", "options"]);
  ...
  var uploadProps = {
    accept: 'image/*',
    name: 'file',
    action: /^http(s)*:\/\//.test(API) ? API : "".concat((0, _endpoint.get)()).concat(API),
  ...
  }, rest), _react["default"].createElement(_upload["default"], uploadProps, fileList.length >= max ? '' : uploadButton), _react["default"].createElement(_modal["default"], {
