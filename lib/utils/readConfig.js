...
function getFormItem(field, modelStatus, _ref) {
  ...
  if (!(0, _checkExpected["default"])(_objectSpread({}, formData, {}, values), options)) {
    return null;
  }
...
var defaultRule = {
  required: function required(value) {
    var msg = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '必填';
    return Boolean(value) === false && value !== 0 ? msg : undefined;
  },
  mail: function mail(value) {
    var msg = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '请输入正确的电子邮箱格式';
    if (value === '') return undefined;
    return /\w+@\w+.\w+/.test(value) ? undefined : msg;
  },
  phone: function phone(value) {
    var msg = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '请输入正确的手机号码格式';
    if (value === '') return undefined;
