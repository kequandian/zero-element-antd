...
function getFormItem(field, modelStatus, _ref) {
  ...
  var fieldName = field.field,
      ...
      rest = (0, _objectWithoutProperties2["default"])(field, ["field", "label", "value", "extra", "span", "rules", "type", "options", "expected"]);
  ...
  if (!(0, _checkExpected["default"])(_objectSpread({}, formData, {}, values), expected || options)) {
    return null;
  }
