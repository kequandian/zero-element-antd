...
export default function Avatars(props) { 
    ...
    function handleClick(){
      const AvaAPI = `${endpoint}/api/crud/avatar/redom/redom`
    ...
    return <div className="User_Avatar"><Upload {...uploadProps} {...restProps} maxCount={1}><Avatar
      style={{
        width:150,
        height:150
      }}
      src={AvaVal?AvaVal:null} onChange={handleChange}></Avatar>
      </Upload>
      <div className="userselect" onClick={handleClick}><AvatarSvg/></div>
      </div>
}
