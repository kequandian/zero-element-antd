...
LayoutSet({
  ...
  MoreSearchLayout: Load('layout/MoreSearchLayout'),
...
CSet({
  ...
  MoreSearch: Load('container/Form/MoreSearch'),
...
FITSet({
  ...
  "link-button": Load('formItemType/LinkButton'),
  "rich-text-plain": Load('formItemType/RichTextPlain'),
  "one-mary-plain": Load('formItemType/OneMaryPlain')
});
AITSet({
...
VTSet({
  ...
  'time-convert': Load('valueType/timeConvert'),
});