...
export default function valueTypeTag(props) {
  ...
  const { map = {},chy = {},colorMap={} } = options;
  return <Tag className={colorMap[text]?'':`_tag_color ${theme} ${type} ${state||chy[text]}`||`_tag_color tag`} style={{"background":colorMap[text],"color":"#fff"}}>
